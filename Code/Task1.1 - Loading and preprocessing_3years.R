...
#### ---- Feature Engineering ----
    ...
    saveRDS(EnergyConsumptionClean, './Output/EnergyConsumptionClean_3years.RDS')
    
    #Save CSV
    write.csv2(EnergyConsumptionClean,'./Output/EnergyConsumption_3years_norownames.csv', row.names = FALSE)
