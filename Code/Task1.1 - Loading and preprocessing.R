...
#### ---- Feature Engineering ----
    ...
    EnergyConsumption<- subset(EnergyConsumption, select=c(DateTime, GAP, Others, Kitchen:WaterHeat_AirCond, Year:Minute))
    head(EnergyConsumption)
    str(EnergyConsumption)
    ...
    saveRDS(EnergyConsumptionClean, './Output/EnergyConsumptionClean.RDS')
